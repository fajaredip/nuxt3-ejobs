<template>
	<div class="flex flex-col">
		<section>
			<div
				class="flex items-center justify-center w-full min-h-[20rem] bg-amber-500 relative"
			>
				<CareerSearch
					class="absolute -bottom-14 left-1/2 transform -translate-x-1/2"
				/>
			</div>
		</section>
		<section>
			<div class="flex items-center justify-center w-full min-h-[20rem]">
				<h1>Featured Section</h1>
			</div>
		</section>
		<section
			class="flex w-full p-5 bg-[linear-gradient(45deg,#282560,#3486c9)] text-white"
		>
			<div class="flex flex-col w-[50rem]">
				<h1 class="text-2xl font-semibold mb-3">About Elabram</h1>
				<p class="mb-3">
					Elabram HR Solution focuses on human resources solutions. The company
					covers every HR needs: from manpower/temporary staff and payroll
					services by HR Outsourcing solution, permanent staff, expatriate
					providers, Executive Search by Recruitment Solutions.
				</p>
