  ...
  >
    <div class="flex flex-col w-full gap-5 xl:w-4/5">
      ...
      >
        ...
        >
          <p class="mb-3 text-4xl font-semibold">
            Assistant Manager Sales {{ id }}
          </p>
          <div class="flex flex-row-reverse items-center gap-5 mb-3 xl:mb-0">
            <div class="flex items-center gap-2">
              26 <Icon name="ph:eye-bold" />
            </div>
            <div
              class="flex items-center gap-2 px-3 py-2 text-xs font-medium bg-gray-300 rounded-md dark:bg-gray-600 whitespace-nowrap"
            >
              <img src="/cb-indonesia.png" class="size-4" alt="" />
              INDONESIA JOB
            </div>
          </div>
        </div>
        <div
          class="flex flex-col items-start justify-between w-full gap-2 mb-7 xl:flex-row xl:w-fit xl:gap-10 xl:mb-0"
        >
          <div class="flex items-center gap-2">
            <Icon name="ph:map-pin-area-bold" class="w-7 lg:w-5" />
            Probolinggo, Indonesia
          </div>
          <div
            class="flex items-center gap-3 text-emerald-600 dark:text-emerald-400"
          >
            <span class="w-7 lg:w-5">IDR</span>
            IDR 10.000.000 - 15.000.000
          </div>
          <div class="flex items-center gap-3">
            <Icon name="ph:briefcase-bold" class="w-7 lg:w-5" />
            2 - 7 years
          </div>
          <div class="flex items-center gap-3">
            <Icon name="ph:graduation-cap-bold" class="w-7 lg:w-5" />
            Bachelor
          </div>
        </div>
        <div class="flex gap-5 xl:hidden">
          <button
            class="flex items-center justify-center px-10 py-2 font-medium text-white bg-green-600 rounded-md hover:bg-green-700 disabled:bg-gray-600"
            :disabled="isLoading"
            @click="handleApply"
          >
            Apply
      ...
      >
        <div class="mb-5">
          <div class="relative flex items-center w-full mb-4">
            <span class="flex-shrink mr-4 text-2xl font-semibold"
          ...
          <ol class="pl-5 list-decimal">
            <li>
              Minimum graduated from reputable university, Bachelor degree in
              Information Technology or related field
            </li>
            <li>
              More than 5 years experiences in software development using
              Microsoft Technology (Vue Js., React Js., JavaScript, Flutter, C#)
            </li>
            <li>Strong in Front end</li>
            <li>Currently not studying</li>
            <li>Have experience in Microservices, .Net, VB6, Ms SQL, etc</li>
            <li>Able to write SQL statements (Queries, DML, DDL)</li>
            <li>Good RDBMS concept</li>
            <li>Have knowledge to the integration with API</li>
            <li>Good knowledge of version control systems such as Git</li>
            <li>Good problem-solving skills and debugging skills</li>
            <li>
              Willing to work on 6-month contract (Potential extension subject
              to performance evaluation)
            </li>
            <li>
              Willing to work onsite from Client Office at Pulomas Jakarta
              Timur.
            </li>
          </ol>
        </div>
