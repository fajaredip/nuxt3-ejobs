...
<template>
	<section>
		...
		>
			<div class="flex flex-col w-full gap-5 lg:w-4/5">
				<div
				...
				>
					...
					>
						...
						<div
							class="flex flex-row-reverse items-center gap-5 mb-3 lg:mb-0"
						>
					...
					<div
						class="flex flex-col items-start justify-between w-full gap-2 mb-7 lg:flex-row lg:w-fit lg:gap-10 lg:mb-0"
					>
						<div class="flex items-center gap-2">
							<i class="fa-solid fa-location-dot w-7 lg:w-5" />
						...
						<div class="flex items-center gap-2">
							<i class="fa-solid fa-briefcase w-7 lg:w-5" />
							2 - 7 years
						</div>
						<div class="flex items-center gap-2">
							<i class="fa-solid fa-graduation-cap w-7 lg:w-5" />
							Bachelor
						</div>
					</div>
				...
				>
					<div class="mb-5">
						<div class="relative flex items-center w-full mb-4">
							<span
								class="flex-shrink mr-4 text-2xl font-semibold"
						...
						<ol class="pl-5 list-decimal">
							<li>
								Minimum graduated from reputable university,
								Bachelor degree in Information Technology or
								related field
							</li>
							<li>
								More than 5 years experiences in software
								development using Microsoft Technology (Vue Js.,
								React Js., JavaScript, Flutter, C#)
							</li>
							<li>Strong in Front end</li>
							<li>Currently not studying</li>
							<li>
								Have experience in Microservices, .Net, VB6, Ms
								SQL, etc
							</li>
							<li>
							...
							<li>
								Good knowledge of version control systems such
								as Git
							</li>
							<li>
							...
							<li>
								Willing to work on 6-month contract (Potential
								extension subject to performance evaluation)
							</li>
							<li>
								Willing to work onsite from Client Office at
